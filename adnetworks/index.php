...
<html lang="he" ng-app="Adnetworks">
	...
	<body>
		...
		<div class="adNetwork">
			<div class="top">
				<div class="one">
					 <input type="text" maxlength="25" class="form-control" id="usr" placeholder="הקלידו כאן משפט שיווקי" onchange="pongoTexto(usr.value)" />
          <button class="botonEnter" onclick="javascript:window.scrollTo(0,350);" dir="rtl">התחילו</button>
				</div>
				<!--<div class="two">
					<span class="num">2</span>
					<b>צפו במסכים לתצוגה מקדימה</b>
				</div>-->
			</div>
			<div class="screens">
				<div dir="rtl" id="a1" class="pc"><a onclick="cambioPc();" style="color: black;"><span id="parrafo3">...עכשיו לקבלת הטבה חינם ולכו לאכול!</span></a>

      <div class="contenedor">
    <div class="btn_dispositivos">
    <a id="uno" onclick="celF();" style="max-width: 80%;"><img style="width:60px;" src="/adnetworks/img/btnCel.png"></a>
  </div>
  <div class="btn_dispositivos">
    <a id="dos" onclick="tabletF();" style="max-width: 80%;"><img style="width:60px;" src="/adnetworks/img/btn_tablet.png"> </a>
  </div>
  <div class="btn_dispositivos">
     <a id="tres" onclick="pcF();" style="max-width: 80%;"> <img style="width:60px;" src="/adnetworks/img/btn_computer.png"> </a>
  </div>
</div>


        </div>
				<div dir="rtl" id="a2" class="tablet"><a onclick="cambioTablet();" style="color: black;"><span id="parrafo2">...עכשיו לקבלת הטבה חינם ולכו לאכול!</span></a>
   <div class="contenedor">
    <div class="btn_dispositivos">
    <a id="uno" onclick="celF();" style="max-width: 80%;"><img style="width:60px;" src="/adnetworks/img/btnCel.png"></a>
  </div>
  ...
  <div class="btn_dispositivos">
     <a id="tres" onclick="pcF();" style="max-width: 80%;"> <img style="width:60px;" src="/adnetworks/img/btn_computer.png"> </a>
				...
				<div dir="rtl" id="a3" class="mobile"><a onclick="cambioCel();" style="color: black;"><span id="parrafo">... עכשיו לקבלת הטבה חינם ולכו לאכול!</span></a>
       <div class="contenedor">
    <div class="btn_dispositivos">
    <a id="uno" onclick="celF();" style="max-width: 80%;"><img style="width:60px;" src="/adnetworks/img/btnCel.png"></a>
  </div>
  ...
  <div class="btn_dispositivos">
     <a id="tres" onclick="pcF();" style="max-width: 80%;"> <img style="width:60px;" src="/adnetworks/img/btn_computer.png"> </a>
        ...
        <div dir="rtl" id="a4" class="pc2"><span id="parrafo">.</span>
         <div class="contenedor2">
    <div class="btn_dispositivos">
    <a onclick="pcF();" style="max-width: 80%;"><img style="width:60px;" src="/adnetworks/img/close.png"></a>
  </div>


        </div>
        </div>
        <div dir="rtl" id="a5" class="tablet2"><span id="parrafo2">.</span>

        <div class="contenedor2">
    <div class="btn_dispositivos">
   <a onclick="tabletF();" style="max-width: 80%;"><img style="width:60px;" src="/adnetworks/img/close.png"></a>
  </div>


        </div>
        </div>
        <div dir="rtl" id="a6" class="mobile2"><span id="parrafo3">.</span>
           <div class="contenedor2">
    <div class="btn_dispositivos">
    <a onclick="celF();" style="max-width: 80%;"><img style="width:60px;" src="/adnetworks/img/close.png"></a>
  </div>


        </div>
			</div>
		<!--	<div class="three" style="margin-bottom: 300px;">
				<button style="width: 100%;" data-toggle="modal" data-target="#myModal">לפרטים נוספים צרו קשר</button>
