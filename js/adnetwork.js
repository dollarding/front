(function (window, document) {
    ...
    loadScript("http://code.jquery.com/jquery-1.12.0.min.js", function () {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                url: 'http://admin.coupit.co.il/api/adNetwork/actions/getCategoriesKeywords',
                dataType: 'json',
                async: false,
		headers: {'X-Alt-Referer': document.location.href },
            ...
            if (allCategories.categories) {
                ...
                var postObject = {
                    AdNetworkId: allCategories.AdNetworkId,
                ...
                $.ajax({
                    type: "POST",
                    url: "http://admin.coupit.co.il/api/adNetwork/actions/detectCategory",
                    data: postObject,
                    dataType: "json",
                ...
                if (advertising) {
                    $('#benefitArea').append("<img src=" + advertising.logo + " width='90' height='50'>");
                    var advertisingLink = 'http://admin.coupit.co.il/api/adNetwork/actions/redirectToSite?AdNetworkId=' + allCategories.AdNetworkId;
                    $('#benefitArea').append('<a class="advertisingLink" href="' + advertisingLink + '" target="_blank">'+advertising.sentences[0]+'</a>');
