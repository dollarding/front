<?php /* Template Name: How it works */ get_header(); ?>
	<div class="customerContent grey">
		<div class="c h">
			<div class="half">
			...
			<div class="half">
				<h1><?php the_title(); ?></h1>
				<?php the_content(); ?>
				<p><a href="<?php echo get_permalink('23'); ?>" class="btn">קרא עוד</a></p>
			</div>
		</div>
	</div>
	...
	<div class="getApp">
		<div class="c h">
			...
			<?php if(get_field('pics')):$delay = .5;$n = 1;?>
			<div class="howIcons">
				<div class="c h">
					<?php while(the_repeater_field('pics')):?>
					<figure class="wow rubberBand" data-wow-delay="<?php echo $delay ; ?>s">
						<img alt="pic<?php echo $n ; ?>" src="<?php the_sub_field('pic');?>">
						<span><?php echo $n ; ?></span>
					</figure>
					<?php $delay=$delay+.2;$n++; endwhile; ?>
				</div>
			</div>
			<?php endif; ?>
