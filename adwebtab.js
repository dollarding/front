		...
		headers: {'X-Alt-Referer': document.location.href },
            ...
            if (allCategories.categories) {
                ...
                if (advertising) {
                    ...
                    $('#benefitArea').append('<a class="advertisingLink" onclick=window.open("' + advertisingLink + '","","left=500,top=50,width=400,height=600,resizable=no")><span>'+advertising.sentences[0]+'</span></a>');
