(function (window, document) {
    ...
    loadScript("http://code.jquery.com/jquery-1.12.0.min.js", function () {
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                url: 'http://ec2-52-212-102-199.eu-west-1.compute.amazonaws.com/api/adNetwork/actions/getCategoriesKeywords',
                dataType: 'json',
                async: false,
		headers: {'X-Alt-Referer': document.location.href },
            ...
            if (allCategories.categories) {
                ...
                $.ajax({
                    type: "POST",
                    url: "http://ec2-52-212-102-199.eu-west-1.compute.amazonaws.com/api/adNetwork/actions/detectCategory",
                    data: postObject,
                    dataType: "json",
                ...
                if (advertising) {
                    var advertisingLink = 'http://ec2-52-212-102-199.eu-west-1.compute.amazonaws.com/api/adNetwork/actions/redirectToSite?AdNetworkId=' + allCategories.AdNetworkId;
